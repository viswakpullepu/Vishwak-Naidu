...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const skills = [
    ...
    '<i class="fas fa-search" style="color: #2e8b57;"></i>',
    '<i class="fas fa-magic" style="color: #ff00ff;"></i>',
    '<i class="fas fa-book" style="color: #fff;"></i>',
    '<i class="fas fa-pen-nib" style="color: #6a5acd;"></i>',
    '<i class="fas fa-video" style="color: #ff4500;"></i>',
    '<i class="fas fa-caret-up" style="color: #fff;"></i>',
    '<i class="fas fa-wind" style="color: #ff8c00;"></i>',
    '<i class="fas fa-paint-brush" style="color: #ff1493;"></i>',
    '<i class="fas fa-copy" style="color: #32cd32;"></i>',
